          ...
          <ul class="dropdown-menu" style="width:300px;">
            ...
            <li class="user-footer">
              <div class="pull-left sameline">
                <a href="{{route('adminprofile')}}" class="btn btn-default" style="color:black">Profile</a>
              </div>
              <div class="sameline">
                <a href="{{route('adminchangepassword')}}" class="btn btn-default" style="color:black; margin-left: 5px;">Change Password</a>
              </div>
              <div class="sameline">
