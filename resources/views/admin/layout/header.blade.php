          ...
          <ul class="dropdown-menu" style="width:300px;">
            ...
            <li class="user-footer">
              <div class="pull-left sameline">
                <a href="{{route('adminprofile')}}" class="btn btn-success" style="color:black">Profile</a>
              </div>
              <div class="sameline">
                <a href="{{route('adminchangepassword')}}" class="btn btn-danger" style="color:black">Change Password</a>
              </div>
              <div class="sameline">
