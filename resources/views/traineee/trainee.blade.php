        ...
        <div class="box box-widget">
            ...
            <div class="box-footer box-comment">
                <form action="/index.html" method="post">
                    ...
                    <div class="img-push">
                        <input type="text" class="form-control input-sm textcomment" placeholder="Please post you comment here" id="{{$trainee_workouts_all[$i]['id']}}">
                                            ...
                                            <div class="box-footer box-comment">
                                                <form action="/index.html" method="post">
                                                    ...
                                                    <div class="img-push">
                                                        ...
                                                        <input type="button" name="" value="Post Comment" class="{{$trainee_workouts[$i]['id']}} submit1 btn btn-success btn-sm pull-right" style="margin-top:10px;">
                                                    </div>
