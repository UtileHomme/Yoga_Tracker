        ...
        <div class="col-md-12">
            ...
            <div class="box box-widget widget-user">
                ...
                <div class="widget-user-header bg-black home-section-background" >
                    <div class="">
                        <h3 class="widget-user-username">{{Auth::user()->name}} <span><a class="link" href="{{route('editprofile')}}" >(Edit Profile)</a></span></h3>
                ...
                <div class="widget-user-image">
                    <img class="img-circle" src="{{ asset(Storage::disk('local')->url($trainee_image)) }}" alt="User Avatar">
                </div>
